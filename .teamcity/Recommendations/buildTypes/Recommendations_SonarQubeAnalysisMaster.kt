...
object Recommendations_SonarQubeAnalysisMaster : BuildType({
    templates(AbsoluteId("PdSonarQubeAnalysisNpmFragment"))
    name = "SonarQube Analysis (Master)"

    buildNumberPattern = "${Recommendations_CommitStage.depParamRefs.buildNumber}"
    ...
    dependencies {
        snapshot(Recommendations_CommitStage) {
        }
    }
})
